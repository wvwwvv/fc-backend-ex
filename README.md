...
### 공통 (Frontend + Backend)
- 프론트엔드/디자인과 백엔드가 도메인 요구사항을 함께 정의하고 API 계약을 조율했습니다.

### Backend 주요 내용
- **API/도메인 구현**: 직관 기록, 경기, 선수, 랭킹, 후원, 베팅 기능 구현
- **인증/인가 구현**: Keycloak 연동, Security 정책 수립, 사용자 식별 로직 구성
- **운영/관리 기능**: 관리자 API(경기/선수 관리, 베팅 정산) 제공
